    ...
    QRCode.toCanvas = function(canvas, text, options, callback) {
        ...
        try {
            var qr = new QRCode(canvas, {
                ...
                correctLevel: options.errorCorrectionLevel || QRCode.CorrectLevel.M
            });
